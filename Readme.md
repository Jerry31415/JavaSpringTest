...
2 вариант:
==========
Запустить микросервис на локальной машине, для этого выполнить скрипт run.bat и дождаться сообщения:
"Started Application in X seconds", 
где X - число затраченного времени на запуск микросервиса (обычно от 10 до 50 секунд). 

Содержимое каталогов:
jar - исполняемый файл. Запускает микросервис на локальной машине
javadoc - javadoc документация
